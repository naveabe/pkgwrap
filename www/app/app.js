...
app.config(['$routeProvider',
	function($routeProvider) {
		$routeProvider.when('/login', {
            ...
            templateUrl: 'app/login/repo-login.html',
            controller : 'repoLoginController'
        }).when('/:repository/:username/:project/configbuilder', {
            templateUrl: 'app/configbuilder/container.html',
            controller : 'ConfigBuilderController'
